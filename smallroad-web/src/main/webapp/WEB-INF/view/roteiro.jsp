...
<body>
 ...
 <div id="main" class="container-fluid" style="margin-top: 50px">
 	...
 	<div id="top" class="row">
		...
		<div class="col-sm-6">
			<form:form action="search" method="POST">
				<div class="input-group h2">
						<input name="data[search]" class="form-control" id="search" type="text" placeholder="Pesquisar Roteiros">
		...
		<div class="col-sm-3">
			<a href="showFormForAdd" class="btn btn-primary pull-right h2">Novo Roteiro</a>
		</div>
	</div> <!-- /#top -->
			...
			<tbody>
				<c:forEach var="roteiro" items="${roteiros}">
					...
					<tr>
						...
						<td>04/06/2017</td>
						<td class="actions">
							<a class="btn btn-success btn-xs" href="${viewLink}">Iniciar Jornada</a>
							<a class="btn btn-warning btn-xs" href="${updateLink}">Editar</a>
							<a  href="${deleteLink}" class="btn btn-danger btn-xs"  onclick="if (!(confirm('Tem certeza que deseja Excluir o roteiro?'))) return false">Excluir</a>
						</td>
					</tr>
